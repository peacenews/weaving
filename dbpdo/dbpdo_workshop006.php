...
$STH = $DBH->query('SELECT data from table1 where userid=01');
...
/*
This example fetches data from the database.
Assuming that the databse and table exist and asuming that the example "dbpdo_workshop005.php"
has alady added the data we are looking to fetch.
Next time, we could look at tests to see whether the data is there, before we try to fetch it.
*/
?>
